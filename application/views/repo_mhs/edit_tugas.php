                    ...
                    <div class="card-body">
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="fakultas" name="fakultas">
                                    <?php foreach ($jurusan as $j) : ?>
                                        <option value="<?= $j['jurusan'] ?>" <?= ($tugas['fakultas'] == $j['jurusan']) ? 'selected' : '' ?>>
                                            <?= $j['jurusan'] ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="judul" id="judul" value="<?= $tugas['judul'] ?>" placeholder="Judul Tugas" required>
                                <?= form_error('judul', '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="dosen_tujuan" id="dosen_tujuan" required>
                                    ...
                                    <?php foreach ($dosen as $d) : ?>
                                        <option value="<?= $d['id'] ?>" <?= ($tugas['dosen_tujuan'] == $d['id']) ? 'selected' : '' ?>>
                                            <?= $d['name'] ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            ...
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="file" name="file" value="<?= $tugas['file'] ?>">
                                <label class="custom-file-label" for="file">Choose file</label>
                                <small class="form-text text-danger"><?= form_error('file') ?></small>
                            </div>
                            <br>
                            <br>
                            <button type="submit" name="edit_tugas" class="btn btn-primary">Edit Tugas</button>
                        </form>
                    </div>
                </div>
            </div>
