<style>
    ...
    ._403:after {
        content: 'Akses Ditolak, Kamu Tidak Login Sebagai Dosen!';
        width: auto;
        height: 20px;
        color: #D32F2F;
        font: 1.5em Arial;
...
<head>
    ...
    <link rel="icon" href="<?= base_url('assets/img/favicon/bsky.png') ?>" type="image/gif">
...
<div class="container">
    ...
    <button class="redirect" id="loginRedirect">Go to login page</button>
</div>
