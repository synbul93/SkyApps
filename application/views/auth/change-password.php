                        ...
                        <div class="col-lg">
                            <div class="p-5">
                                <div class="text-center">
                                    <img src="<?= base_url('assets/img/bsky.png') ?>" width="60px">
                                    <h1 class="h4 text-gray-900">Change your password for</h1>
                                    <h5 class="mb-4"><?= $this->load->session->userdata('reset_email'); ?></h5>
                                </div>
                                ...
                                <form class="user" method="post" action="<?= base_url('auth/changepassword') ?>">
                                    ...
                                    <div class="form-group">
                                        <input type="password" class="form-control form-control-user" id="password2" name="password2" placeholder="Repeat Password" value="">
